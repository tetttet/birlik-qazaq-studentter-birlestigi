...
const BlogPostDetail = () => {
    ...
    const i18n = { language: 'en' }; // Замените на реальный способ получения языка
            ...
            <div className="w-full mt-10">
                <div className="flex bg-white" style={{ height: '600px' }}>
                    <div className="flex items-center text-center lg:text-left px-8 md:px-12 lg:w-1/2">
                        <div>
                            <h2 className="text-3xl font-semibold text-gray-800 md:text-4xl">Blog - <span className="text-indigo-600">
                            ...
                            <div className="flex justify-center lg:justify-start mt-6">
                                ...
                                <Link to={url} className="mx-4 px-4 py-3 bg-gray-300 text-gray-900 text-xs font-semibold rounded hover:bg-gray-400">
                                    Learn More
                                </Link>
                            </div>
                        </div>
