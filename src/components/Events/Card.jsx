...
function Card() {
    ...
    const items = [
        {
            title: "Бірыңғай көзқарас",
            description:
                "Біз бірлікте үлкен күш бар екеніне сенеміз. Технологиялар тек қана құрал — бастысы, олар адамдарды біріктіріп, денсаулықты күту жолында көмектесуі керек.",
      ...
      <path d="M4 26H60" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
        ...
        },
        {
            ...
            description:
                "Мы создаём свои технологии и адаптируем их под ваши задачи — для интеграции, лицензии или полной кастомизации.",
            image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        },
        {
            title: "Партнёрство",
            description:
                "Сотрудничаем с компаниями в сфере страхования и медицины, чтобы вместе создавать полезные цифровые решения.",
            image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        },
        {
            ...
            description: "Мы не только эксперты в технологиях, но и в здравоохранении. Мы умеем работать в условиях строгих нормативных требований и сложной работы с данными.",
            image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
