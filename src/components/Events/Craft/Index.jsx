    ...
    return (
        ...
        >
            <div className="ltext sm:sticky sm:top-[10%] left-0 sm:w-1/2 ">
                ...
                >
                    Birlik Qazaq Studentter Birlestigi - қазақ тілі мен мәдениетін қолдау мақсатында қазақстандық жоғары оқу орындарының студенттері мен түлектерін біріктіретін волонтерлік ұйым. Біз жастар қазақ тілі мен мәдениетін білім беру ортасында және одан тыс жерлерде насихаттау үшін білім, тәжірибе және ресурстармен бөлісетін қоғамдастық құруға ұмтыламыз.
                </p>
                {/* button */}
                <br />
