...
const data = [
    ...
    },
    {
        ...
        desc: "Akdeniz Üniversitesi (Анталия) көшбасшысы",
        date: "2024-2025",
        status: "пост сдал(не действующий)",
        img: "6.jpeg"
    },
    {
...
const Card = ({ name, desc, date, status, img }) => {
    const statusColor = status === "действующий" ? "bg-green-500" : "bg-gray-400";
            ...
            <div className="bg-white rounded-t-3xl shadow-lg w-[350px] mx-4 rounded-3xl overflow-hidden shadow-sm transform transition-all hover:scale-105 flex flex-col">
                ...
                <div className="p-6 flex-1 flex flex-col">
                    <div className="flex justify-between items-start mb-3">
                        ...
                        <span className={`${statusColor} text-white text-xs px-2 py-1 rounded-full flex-shrink-0 ml-2`}>
                            {status}
                        </span>
                    </div>
    ...
    return (
        <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto ml-5 md:ml-56 lg:ml-48">
                <h1 className="text-3xl font-bold text-center text-gray-900 mb-12">История Руководства</h1>
